...
Blockly.Blocks.pgkit_construct_XPORTS = {
  init: function () {
    ...
    function getMyTypes() {
      return Blockly.getPGKitConnectableNameTypesByPort(dropdownPorts.value_, [Blockly.Msg.MY_NULL, '']);
    }
    ...
    /*dropdownPorts.onItemSelected = function (menu, menuItem) {
        ...
        if (this.sourceBlock_) {
            ...
            var types = Blockly.getPGKitConnectableNameTypesByPort(value, [Blockly.Msg.MY_NULL, '']);
            _this.dropdownTypes.setValue(types[0][1]);
            var models = Blockly.getPGKitConnectableNameModelsByPort(value, types[0][1], [Blockly.Msg.MY_NULL, '']);
    ...
    function getMyModels() {
      return Blockly.getPGKitConnectableNameModelsByPort(dropdownPorts.value_, dropdownTypes.value_, [Blockly.Msg.MY_NULL, '']);
    }
    ...
    dropdownTypes.onItemSelected = function (menu, menuItem) {
        ...
        if (this.sourceBlock_) {
            ...
            var models = Blockly.getPGKitConnectableNameModelsByPort(dropdownPorts.value_, value, [Blockly.Msg.MY_NULL, '']);
            _this.dropdownModels.setValue(models[0][1]);
        }
        if (value !== null) {
            this.setValue(value);
