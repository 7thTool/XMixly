...
void finish()
{
	...
	addr = pos_stack_len + 1;
	pos_stack_len += pos_stack_pointer;
	EEPROM.put(POS_STACK_BASE_ADDR, pos_stack_len);
    for (i=0; i<pos_stack_pointer; i++) {
...
void setup() {
    ...
    Serial.println("--10");  //need delay???  why???
