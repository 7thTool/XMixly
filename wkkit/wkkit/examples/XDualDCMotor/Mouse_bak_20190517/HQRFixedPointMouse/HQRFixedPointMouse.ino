...
// 预先标定的目标位置坐标
const uint8_t target[4][2] = {{0,0}, {4,0}, {4,4}, {0,4}};
...
void finish()
{
	...
	switch (flag) {
	case 0:
		lgs.showMeteor(2,  0x300000, 5);
		break;
	case 1:
		lgs.showMeteor(2,  0x002000, 5);
		break;
	case 2:
		lgs.showMeteor(2,  0x000030, 5);
		break;
	case 3:
		lgs.showMeteor(2,  0x202020, 5);
		break;
	default:
		break;
	}	
...
void loop() {
	...
	while (true) {			
		...
		case 0:
			...
			break;
		case 1:
			lgs.showColor(0,  0x300000);
			break;
		case 2:
			lgs.showColor(0,  0x002000);
			break;
		case 3:
			lgs.showColor(0,  0x000030);
			break;
		default:
			break;
		}	
