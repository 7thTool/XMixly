 ...
 *
 * Description: 
 *     This file is a header file for WKKSystem.cpp.
 *
 * Version: 1.0.0
 */


#ifndef __WKKSYSTEM_H__
#define __WKKSYSTEM_H__


#include <wkkit.h>


//#define WKK_SLEEP_ENABLE


#define WKK_SLEEP_MODE_IDLE 	(0x00<<1)	//Least power saving
#define WKK_SLEEP_MODE_ADC 		(0x01<<1)
#define WKK_SLEEP_MODE_PWR_DOWN (0x02<<1)   //Most power saving
#define WKK_SLEEP_MODE_PWR_SAVE (0x03<<1)
#define WKK_SLEEP_MODE_STANDBY 	(0x06<<1)
...
public:
	...
	*/
	...
	void getBID(uint8_t BID[5], uint8_t *key=NULL);
	void setBID2(uint8_t code);
	...
	*/
	...
	//WKK_SLEEP_MODE_XX
	void sleep(uint8_t mode=WKK_SLEEP_MODE_IDLE);
#endif
	void reboot();

private:
#ifdef WKK_SLEEP_ENABLE
	void avrSleep(uint8_t mode);
#endif
};
